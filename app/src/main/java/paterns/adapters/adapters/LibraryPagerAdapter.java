...
public class LibraryPagerAdapter extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        switch (position) {
            case 0:
                return ContentFragment.newInstance("Читаю");
            case 1:
                return ContentFragment.newInstance("Буду читати");
            case 2:
                return ContentFragment.newInstance("Прочитано");
            case 3:
                return ContentFragment.newInstance("Улюблене");
            default:
                return ContentFragment.newInstance("Читаю");
        }
    }
